...
const experiences = [
  {
    ...
    bullets: [
      ...
      'Built an AI document-validation prototype (OCR + ML + rules) for deal-funding review and took it through the company’s first internal innovation review; piloted on 50+ deal packages, it cuts review from 1–2 hours to about 5 minutes, each verdict logged to a per-deal audit trail.',
